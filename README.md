...
**Jump to:** [Talks](#upcoming-talks) | [Skills](#agent-skills) | [Azure](#azure-related-samples) | [MCP](#mcp-related-samples) | [Agents](#personal-agentic-helpers) | [Templates](#python-templates-with-devcontainers) | [Education](#educational-tools-build-with-pyodide-in-browser-python) | [Frontend](#frontend-packages)
...
| [PyLadies Con](https://2026.conference.pyladies.com/) | Online | Dec 5-7 | 
| [AI Tour](https://aitour.microsoft.com/flow/microsoft/seattle27/citylanding/page/cityhome) | Seattle | Dec 9 |
...
| Skill | Dependencies |
| --- | --- |
| [recap-my-week](https://github.com/pamelafox/recap-my-week) | GitHub MCP, X MCP, workIQ MCP |
| [comedy-roast-skill](https://github.com/pamelafox/comedy-roast-skill) | GitHub MCP, X MCP, workIQ MCP |
| [presentation-skills](https://github.com/pamelafox/presentation-skills) | yt-dlbp, ffmpeg, etc. |
| [review-pr-comments](https://github.com/pamelafox/review-pr-comments) | GitHub API/MCP/gh |
...
| [model-swap-workshop](https://github.com/pamelafox/model-swap-workshop) | openai | Foundry Models | - | ✅  
