...
Upcoming talks: [Python + AI Office Hours](http://aka.ms/aipython/oh), [PyBay (SF)](https://pybay.org/), [Build AI Apps with Postgres](https://developer.microsoft.com/reactor/events/26071/)
